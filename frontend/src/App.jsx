    ...
    <section ref={sectionRef} className="h-full w-full box-border px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-8 md:py-12 text-white overflow-hidden">
      <div key={animationRun} className="w-full h-full min-h-0 flex flex-col section6-animated">
        ...
        <div className="section6-scroll flex-1 min-h-0 overflow-y-auto flex flex-col gap-3 sm:gap-5 pr-1">
          ...
          <div className="mt-auto grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 min-h-[220px] md:min-h-[260px]" style={{ fontFamily: 'Inter' }}>
            <div className="rounded-xl border border-white/20 bg-black/25 p-4 sm:p-5 md:p-6 section6-card section6-card-8 flex flex-col justify-center">
              <p className="text-[#E8B88A] font-semibold text-base sm:text-lg mb-2">VCET, Puttur</p>
              <p className="text-white/90 text-sm sm:text-base leading-relaxed">
                Vivekananda College of Engineering & Technology,
                <br />
                Nehru Nagar, Puttur,
                <br />
                Dakshina Kannada, Karnataka 574203
              </p>
            </div>
